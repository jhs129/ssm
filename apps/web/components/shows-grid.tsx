...
async function getShows() {
  ...
  return shows
    ...
    .sort((a, b) => SHOW_ORDER.indexOf(a.data?.slug) - SHOW_ORDER.indexOf(b.data?.slug))
}

export async function ShowsGrid() {
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        <div className="mb-16 flex flex-col items-center text-center">
          ...
          <h2 className="font-display text-4xl font-bold uppercase tracking-tight text-foreground md:text-5xl">
            <span className="text-balance">Three Shows, One Mission</span>
          </h2>
